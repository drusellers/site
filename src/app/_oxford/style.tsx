...
export const Route = createFileRoute("/_oxford/style")({
	component: Style,
});
			...
			<TwoColumnGrid>
				<div className={"prose prose-drusellers"}>
					...
					<p>
						...
						variety of subtle colors. A guilloche pattern of 1&apos;s and
						0&apos;s that&apos;s pretty fine like the idea of
						&ldquo;micro-print&rdquo; on currency. You have to
						&ldquo;zoom&rdquo; to some extent to see it. Its subtle, like
						weaving money and technology. I would love to have it in SVG so I
						would easily swap colors to fit with the brand.
					</p>
					<h1>1. Fonts</h1>
					<p>
						Headers: Helvetica - when i see this in bold headers it really feels
						like the standard white paper. I&apos;m ok with that. I&apos;ll
						spend my &ldquo;fun&rdquo; elsewhere.
					</p>
					<p>Body Copy: Helvetica - same, same</p>
					<h1>1. Colors</h1>
					<p>
						Blues / Blacks - Blue is a core part of the internet. Links are
						blue. While the OG blue is a bit too dark for me I want to maintain
						that history of blue links. So, blue should be an accent color in
						some ways at least.
					</p>
					...
					<p>
						Always like the idea of finding a way to work feminine colors in.
						What is the feminine version of serious? I feel like the blues of
						IBM, dark tones are what makes a manly color serious.
					</p>
					<p>
