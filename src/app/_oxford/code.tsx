...
export const Route = createFileRoute("/_oxford/code")({
	component: Code,
});
				...
				<div>
					<ol className={"flex flex-col space-y-4"}>
						<li>
							...
							will take care of my physical surroundings, keeping them in order.
						</li>
						<li>
						...
						<li>
							...
							care of my friends and family and treat other people with respect.
						</li>
						<li>
							{" "}
...
function Sidebar() {
	return (
		<div className={"col-span-3 text-right"}>Adapted from Jocko Willink</div>
	);
}
