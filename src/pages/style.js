...
export default function Style() {
  return (
    <Layout title="Style Guide">
      ...
      <p>Serious</p>
      <p>
        I tend to like <a href="https://simple.com">Simple.com's</a> brand.
        Clean whites with a bit of color
      </p>
      ...
      <p>
        ...
        variety of subtle colors. A guilloche pattern of 1's and 0's that's
        pretty fine like the idea of "micro-print" on currency. You have to
        "zoom" to some extent to see it. Its subtle, like weaving money and
        techology. I would love to have it in SVG so I would easily swap colors
        to fit with the brand.
      </p>
      <h1>1. Fonts</h1>
      <p>
        Headers: Helvetica - when i see this in bold headers it really feels
        like the standard white paper. I'm ok with that. I'll spend my "fun"
        elsewhere.
      </p>
      ...
      <p>
        Always like the idea of finding a way to work femine colors in. What is
        the femine version of serious? I feel like the blues of IBM, dark tones
        are what makes a manly color serious.
      </p>
      <p>
