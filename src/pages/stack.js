...
export default function Stack() {
  return (
    <Layout title="Stack" date="2019-10-28">
      <p>
        I'm a productivity wonk. I have been for a very long time. I would track
        ...
        back in the day, I've been in love with wikis (c2wiki, tidlywiki, etc.)
        I loved Stephen Covey's 7 habits. Because of this leaning I was primed
        when David Allen dropped his{" "}
        <a href="https://www.amazon.com/Getting-Things-Done-Stress-Free-Productivity/dp/0142000280">
          Getting Things Done
        </a>{" "}
      ...
      <ul>
        ...
        <li>
          <strong>Mental Floss</strong> I actively engage a therapist to work
        ...
        <li>
          <strong>Meditation</strong> I haven't gotten to 30 or 60 min each day,
        ...
        <li>
          <strong>Food Prep</strong> this is a part of falling into the pit of
      ...
      <ul>
        <li>
          <strong>Getting Things Done</strong> this is a book that describes a
        ...
        <li>
          <strong>43 Folders</strong>: While archaic in this time, its useful to
        ...
        <li>
          <strong>Sunday Reflections</strong>: on Sundays I spend my mornings by
        ...
        <li>
          <strong>Note Compaction</strong>: I carry with me a spiral notebook
        ...
        <li>
          <strong>1-3-1</strong> This is a weekly reflection technique that a
        ...
        <li>
          <strong>Mirror Notes</strong> until I find a better system, i find
      ...
      <h2>Tools</h2>
      <strong>Mac</strong> when I started the foundational tool that I expected
      ...
      me.
      <strong>One Big Monitor</strong> i used to be a big double monitor kid,
      ...
      <strong>3 subject spiral binder</strong> my go to quick note taking
      ...
      <strong>Caffiene</strong> true fact, nuff said
      <h2>Minor Tools</h2>
      <blockquote>This is probably what you really wanted</blockquote>
      <ul>
        <li>
          <strong>Things</strong>
          <ul>
            <li>
              tweaked the quick add feature to facilitate getting items into the
              inbox
            </li>
            <li>leverage repeating tasks to help jog my day</li>
            <li>
              Wishes - how to get things + preferred calendar tool to work
              together
            </li>
          </ul>
        </li>
        <li>
          <strong>iMessages</strong> this just works between iPad, iPhone, and
          my Mac. No _bs_ just works.
        </li>
        <li>
          <strong>Superhuman</strong> for email. I like having a dedicated app
          for things so that I can `CMD+TAB` to the app i want or use my window
          manager. Can't do that with Google or Firefox tabs
        </li>
        <li>
          <strong>Fantastical 2</strong> not a huge game changer here, this
          entry is still contested
        </li>
        <li>
          <strong>Evernote</strong> this is slowly dieing off as I move content
          to either my gitbook hosted system or 1Password for secure things but
          its image capture of notes is still one of the best
        </li>
        <li>
          <strong>Paper</strong> The Mac drawing app (not Dropbox Paper)
        </li>
        <li>
          <strong>1Password</strong> for secrets
        </li>
        <li>
          <strong>
            <a href="https://pqrs.org/osx/karabiner/">Karabiner</a>
          </strong>{" "}
          hot key manager utilized with{" "}
          <strong>
            <a href="https://github.com/jigish/slate">Slate</a>
          </strong>{" "}
          for window management. I would be interested in a for-fee solution and
          I could spend a bit more time here but I'm not sure its a major needle
          mover, especially now.
        </li>
      </ul>
    </Layout>
  );
