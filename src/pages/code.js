...
export default function Code() {
  return (
    <Layout title="Code" subtitle="Adapted from Jocko Willink">
      <ol>
        <li>
          I will take care of my physical health by exercising, eating properly,
          and getting the rest I need ot recover and rebuild. I will take care
          of my physical surroundings, keeping them in order.
        </li>
        <li>
          I will develop myself mentally by reading, writing, drawing, building,
          creating, and engaging in other activities that sharpen and expand my
          mind.
        </li>
        ...
        <li>
          I will control my emotions and not allow my emotions to negatively
          impact my decisions.
        </li>
        <li>
          I wil put others before myself. I will help other people and protect
          those that that cannot protect themselves. I will take care of my
