...
export default function Code() {
  return (
    <PagePage title="Code" subtitle="Adapted from Jocko Willink">
      <div>
        <ol>
          <li>
            I will take care of my physical health by exercising, eating
            properly, and getting the rest I need ot recover and rebuild. I will
            take care of my physical surroundings, keeping them in order.
          </li>
          <li>
            I will develop myself mentally by reading, writing, drawing,
            building, creating, and engaging in other activities that sharpen
            and expand my mind.
          </li>
          ...
          <li>
            {' '}
            I will experience my emotions, I will not bury them but nor will I
            let them control me.
          </li>
        </ol>
